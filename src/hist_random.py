...
from fast_histogram.bin_gen import random_bins, construct_monotonic_bins
import numpy as np
...
print("==============================================")
print("RANDOM BIN DISTRIBUTION PERFORMANCE EVALUATION")
print("==============================================")
...
for nbins in N_BINS:
    for min_width in MIN_WIDTH:
        np.random.seed(0)
        bins = random_bins(nbins, WIDTH, min_width)
